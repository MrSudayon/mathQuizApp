...
if (@$_GET['q'] == 2) {
   ...
   echo '<div class="panel title">
    ...
    <tr><td style="vertical-align:middle">Questions</td><td style="vertical-align:middle">Correct</td><td style="vertical-align:middle">Wrong</td></tr>';    $c = 0;
    while ($row = mysqli_fetch_array($q)) {
        $eid = $row['eid'];
        $s   = $row['score'];
        $w   = $row['wrong'];
        ...
        <td style="vertical-align:middle">
        <a href="account.php?q=result&eid=' . $eid . '" class="btn" style="color:black;background-color: #007939c2;padding: 5px; border-bottom-left-radius: 5px;
        border-bottom-right-radius: 5px;border-top-left-radius: 5px; border-top-right-radius: 5px;">View</a>
        </td>
        </tr>';
    }
    echo '</table></div>';
...
if (@$_GET['q'] == 3) {
    ...
    echo'<br><center><h5 style="color: white; width: 100%; background-color:#148110;padding: 15px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;border-top-left-radius: 5px;
    border-top-right-radius: 5px; font-size: 15px;"><i class="fa fa-graduation-cap"></i>&nbsp;Leaderboards&nbsp;<br></center>';
    echo '<br>';
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr>
            <td style="vertical-align:middle; color: green;"><b>' . $c . '</b></td>
            <td style="vertical-align:middle">' . $name . '</td>
            <td style="vertical-align:middle">' . $s . '</td>
            <tr>';
        }
