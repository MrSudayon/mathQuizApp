...
<body><center>
    ...
    <!-- Start Top Bar -->
    <div class="top-bar" style="background-color: #007938; border-bottom: 5px solid #1E5128;" >
      <div class="top-bar-left">
        <ul class="menu"  style="background-color: #007938">
          <li class="menu-text" style="color:white;">
            ...
            <?php
                ...
                if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
                    ...
                    include_once 'dbConnection.php';
                    echo 'Hi, ' . $username . ' <i class="fa fa-check-circle"></i> ';
                }
            ?></li>
          <li><li <?php
                if (@$_GET['q'] == 0)
               ...
               <li <?php
                if (@$_GET['q'] == 6)
                    echo 'class="active"';
                ?>><a href="dash.php?q=6" style="color:white;">&nbsp; Reports</a></li> 
                ...
                if (@$_GET['q'] == 7)
                    echo 'class="active"';
                ?>><a href="addlessonchoi.php" style="color:white;">&nbsp; Add Lessons</a></li>
...
//While loop insert before

#################################################################################### REMOVE QUIZ #######################################################################
if (@$_GET['q'] == 5) {
    echo '<B>FOR UNIT 1 ONLY</B>';
    $result = mysqli_query($con, "SELECT * FROM quiz ORDER BY date DESC") or die('Error');
    echo '<div class="panel"><table class="" style"with: 100%;";>
<tr><td style="vertical-align:middle"><b>Number</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $title   = $row['title'];
        $total   = $row['total'];
  ...
  <td style="vertical-align:middle"><b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="btn" style="padding:5px;background:#e74c3c;color:white; border-bottom-left-radius: 6px;
  border-bottom-right-radius:6px; border-top-left-radius: 6px; border-top-right-radius: 6px;">&nbsp;<b>Delete</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>Number</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $eid     = $row['eid'];
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="update2.php?q=rmquiz&eid=' . $eid . '" class="btn" style="padding:5px;background:#e74c3c;color:white; border-bottom-left-radius: 6px;
  border-bottom-right-radius:6px; border-top-left-radius: 6px; border-top-right-radius: 6px;">&nbsp;<b>Delete</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>Number</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $eid     = $row['eid'];
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="update3.php?q=rmquiz&eid=' . $eid . '" class="btn" style="padding:5px;background:#e74c3c;color:white; border-bottom-left-radius: 6px;
  border-bottom-right-radius:6px; border-top-left-radius: 6px; border-top-right-radius: 6px;">&nbsp;<b>Delete</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>Number</b></td><td style="vertical-align:middle"><b>Topic</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $eid     = $row['eid'];
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="update4.php?q=rmquiz&eid=' . $eid . '" class="btn" style="padding:5px;background:#e74c3c;color:white; border-bottom-left-radius: 6px;
  border-bottom-right-radius:6px; border-top-left-radius: 6px; border-top-right-radius: 6px;">&nbsp;<b>Delete</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>#</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Number</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Phone (Optional)</b></td><td style="vertical-align:middle"></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $name      = $row['name'];
        $phno      = $row['phno'];
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    ...
    <div class="">
    <span class="title1" style="font-size:30px;"><b>Enter Question Details <p style="background-color: #F0A500; color: white; ">UNIT 2</p></b></span><br /><br />
