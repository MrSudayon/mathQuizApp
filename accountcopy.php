    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {
            echo '<tr>
                    ...
                    <td style="vertical-align:middle"><b><a href="accountcopy.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:white; background-color:#148110;width: 100%; padding: 5px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;border-top-left-radius: 5px;border-top-right-radius: 5px; font-size: 15px;">Start</td>
                </tr>';
        } else {
            ...
            if ($remaining > 0 && $qstatus == "enabled" && $status == "ongoing") {
                ...
                <td style="vertical-align:middle"><b><a href="accountcopy.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:white;background-color:#f1c40f;padding: 5px; border-bottom-left-radius: 5px;
                border-bottom-right-radius: 5px;border-top-left-radius: 5px; border-top-right-radius: 5px;">&nbsp;Resume</span></a></b></td></tr>';
            } else {
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<td style="vertical-align:middle">' . $total . '</td>  </td>
                <td style="vertical-align:middle"><b><a href="accountcopy.php?q=result&eid=' . $eid . '" class="btn" style="color:white;background-color:#1C7947;padding: 5px; border-bottom-left-radius: 5px;
