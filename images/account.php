...
if (@$_GET['q'] == 1) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {
            echo '<tr>
                    <td style="vertical-align:middle;">' . $c++ . '</td><td style="vertical-align:middle;">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td>    
                    <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:white;background-color:#007939c2;padding: 5px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;border-top-left-radius: 5px;border-top-right-radius: 5px; font-size: 15px;"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Start&nbsp;&nbsp;&nbsp;</a></b></td>
                </tr>';
        } else {
            ...
            if ($remaining > 0 && $qstatus == "enabled" && $status == "ongoing") {
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
                <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:white;background-color:#f1c40f;padding: 5px; border-bottom-left-radius: 5px;
                border-bottom-right-radius: 5px;border-top-left-radius: 5px; border-top-right-radius: 5px;">&nbsp;Resume</span></a></b></td></tr>';
            } else {
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
                <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="color:white;background-color:#1C7947;padding: 5px; border-bottom-left-radius: 5px;
        ...
        if ($status == "ongoing" && $remaining > 0 && $qstatus == "enabled") {
            ...
            var seconds = ' . $remaining . ' ;
             ...
             echo '
                <table style="width:100%;">
                <tr>
                <th><font style="color: white; background-color:#007939c2;padding: 5px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;border-top-left-radius: 5px;border-top-right-radius: 5px; font-size: 15px;"><i class="fa fa-clock-o"></i> &nbsp;Time left: <span class="timer btn btn-default"><font style="font-size:15px;font-weight:light;color:white" id="countdown"></font></span> </font><br>
                </th>
...
if (@$_GET['q'] == 2) {
   ...
   echo '<div class="panel title">
    ...
    while ($row = mysqli_fetch_array($q)) {
        ...
        <td style="vertical-align:middle"><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="color:white;background-color: #007939c2;padding: 5px; border-bottom-left-radius: 5px;
...
if (@$_GET['q'] == 3) {
    ...
    echo'<br><center><h5 style="color: white; width: 100%; background-color:#148110;padding: 15px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;border-top-left-radius: 5px;border-top-right-radius: 5px; font-size: 15px;"><i class="fa fa-graduation-cap"></i>&nbsp;Leaderboards&nbsp;<br></center>';
    echo '<br>';

    echo '<div class="panel title" style="width:100%;";> 
<table class="" style="vertical-align:middle; width:100%;">
<tr><td style="vertical-align:middle" ><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle;"><b>Score</b></td></tr>';
    $c = $showfrom-1;
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr><td style="vertical-align:middle;"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle">';
        }
    }
    else{
    }
    ...
    if($show == 1 && $total==1){
        ...
        echo '<td style="vertical-align:middle;text-align:center"><a style="color:white;font-size:16px;font-family:calibri;border-radius:4px; background-color: #125C13;" href="account.php?q=3&show='.($show+1).'">&nbsp;<i class="fa fa-forward fa fw"></i>&nbsp;</a></td>';
    }
    else if($show != 1 && $show==$total){                                                                                                                                                                       /* Arrow next*/
        echo '<td style="vertical-align:middle;text-align:center"><a style="color:white;font-size:16px;font-family:calibri;border-radius:4px; background-color: #125C13;" href="account.php?q=3&show='.($show-1).'">&nbsp;<i class="fa fa-backward fa fw"></i>&nbsp;</a></td>';
