...
if($_SERVER["REQUEST_METHOD"] == "POST" ){
    ...
    if(empty($_POST["ending"])){
        ...
        $ending= $_POST["ending"];
                ...
                $query = mysqli_query($connections, "INSERT INTO lesson3 (headline,context,content,ending) VALUES ('$headline', '$context', '$content', '$ending')");
                echo "<script>window.location.href='lessons3.php';</script>";
...
<body><br>
    ...
    <br>
    <center><a href='dash.php?q=0' style="
                text-align: center;  
                background-color: #006aff; /* Green */ 
                border: none; color: white;float: center;
                padding: 15px 32px;
                ...
                border-top-left-radius: 10px;
                height: 55px;
                border-top-right-radius: 10px;">Disregard</a>
                <br><br>
...
$view_query = mysqli_query($connections, "SELECT * FROM lesson3");
...
while($row = mysqli_fetch_assoc($view_query)){
    ...
    <td> $content</td>
    <td> $ending</td>
    <td><a href='edit3.php?id=$id'  style='color: green'><b>Edit</b></a>
    &nbsp;
    <a href='delete3.php?id=$id' style='color: red'><b>Remove</b></a>
    </td>
    </tr>";
}
